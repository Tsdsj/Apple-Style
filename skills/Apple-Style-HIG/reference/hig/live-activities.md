...
![An illustration a Live Activity that draws content to the edge of the Dynamic Island.]
...
![An illustration of a Live Activity with content in an inset, rounded shape to group it together.]

![A checkmark in a circle to indicate correct usage.]

![An illustration of a Live Activity that uses a line to separate a block of content.]
...
![An illustration that shows a compact presentation that appears unbalanced and too wide because it uses padding around the TrueDepth camera.]
