...
![A stylized representation of an alert mockup that includes a title, description, primary button, and secondary button. The image is tinted red to subtly reflect the red in the original six-color Apple logo.]
...
![An illustration of an alert in the middle of the screen on iPhone.]

**macOS**

![An illustration of an alert in the middle of the screen on a Mac.]

**tvOS**

![An illustration of an alert on tvOS.]

**visionOS**

![An illustration of an alert on Apple Vision Pro.]

**watchOS**

![An illustration of an alert on Apple Watch.]
