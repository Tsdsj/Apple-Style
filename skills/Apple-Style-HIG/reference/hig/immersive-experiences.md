...
![A screenshot of a highlighted window in the Shared Space with dimmed passthrough.]
...
[video: A recording of a fully immersive experience in which a video player window appears on top of an Environment. As the viewer adjusts the Digital Crown, passthrough increases to reveal more of the person's physical surroundings.]
...
![A screenshot of an app running in a Full Space using the progressive immersion style in visionOS.]

**Full Space (Immersive)**

![A screenshot of an app running in a Full Space using the full immersion style in visionOS.]
