...
![A stylized representation of a popover view. The image is tinted red to subtly reflect the red in the original six-color Apple logo.]
...
![An illustration of an event in Calendar with the attached version of the event's popover next to and pointing to it.]

**Detached popover**

![An illustration of an event in Calendar with the detached version of the event's popover next to it.]
