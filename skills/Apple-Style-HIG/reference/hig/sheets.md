...
![A stylized representation of a sheet extending down from the top of a window. The image is tinted red to subtly reflect the red in the original six-color Apple logo.]
...
![A screenshot of the same in-progress note on iPhone. Different words are selected and highlighted. The format sheet shows that the selected words use the body font in italics.]
...
![An illustration of the top half of a sheet on iPhone. A Done button appears in the top-right corner on its own.]

![An X in a circle to indicate incorrect usage.]

![An illustration of the top half of a sheet on iPhone. A Cancel button appears in the top-left corner of the view, and a Done button appears in the top-right corner.]

![A checkmark in a circle to indicate correct usage.]

Avoid showing all three buttons — Cancel, Done, and Back — together.

![An illustration of the top half of a sheet on iPhone. A Back button appears in the top-left corner of the view, and Cancel and Done buttons appear together in the top-right corner.]
...
![An illustration of the top half of a sheet on iPhone. A Cancel button appears in the top-left corner of the view, and an inactive Done button appears in the top-right corner.]

**Subsequent step**

![An illustration of the top half of a sheet on iPhone. A Back button appears in the top-left corner of the view, and an inactive Done button appears in the top-right corner.]

**Final step**

![An illustration of the top half of a sheet on iPhone. A Back button appears in the top-left corner of the view, and a Done button appears in the top-right corner.]
...
![An illustration showing an iPhone screen in portrait orientation containing a solid rounded rectangle that occupies almost all of the screen, representing a full-screen sheet. A rounded close button appears in the upper-left corner of the sheet.]

![An illustration showing an iPhone screen in portrait orientation containing a solid rounded rectangle that occupies half of the screen, representing a half-screen sheet. A rounded close button appears in the upper-left corner of the sheet.]
...
![A screenshot of the Notes app, with the What's New in Notes sheet centered on top of a dimmed Notes document in the background.]
...
![A screenshot of a sheet with a primary Action button and a default cancel button on Apple Watch.]
...
![A screenshot that shows a top toolbar with a custom Back button at the top of the screen on Apple Watch.]

![An X in a circle to indicate incorrect usage.]

![A screenshot that shows a top toolbar with a button with the words Page title at the top of the screen on Apple Watch.]

![An X in a circle to indicate incorrect usage.]

![A screenshot that shows a top toolbar with the default Cancel button at the top of the screen on Apple Watch.]
