...
![An illustration of a button that includes the Apple logo and text that reads 'Sign in with Apple'.]

![An illustration of a button that includes the Apple logo and text that reads 'Sign up with Apple'.]

![An illustration of a button that includes the Apple logo and text that reads 'Continue with Apple'.]
...
![An illustration of a white button correctly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]

![A checkmark in a circle to indicate correct usage.]

![An illustration of a white button incorrectly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]
...
![An illustration of a white, outlined button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]

![A checkmark in a circle to indicate correct usage.]

![An illustration of a white, outlined button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]
...
![An illustration of a black button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]

![A checkmark in a circle to indicate correct usage.]

![An illustration of a black button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.]
...
![An illustration of a 'Sign in with Apple' button with 90-degree corners.]

![An illustration of a 'Sign in with Apple' button with the default corner radius.]

![An illustration of a 'Sign in with Apple' button with the maximum corner radius, which results in a capsule-like appearance.]
...
![A illustration of a black Apple logo within a white square, which is surrounded by a thick, shaded border. The white square represents the minimum amount of clear space between the Apple logo and other interface elements.]

![A illustration of a white Apple logo within a black square, which is surrounded by a thick, light border. The black square represents the minimum amount of clear space between the Apple logo and other interface elements.]
...
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has rounded corners.]

![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has square corners.]

![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button is circular.]
