...
![A sketch of the Live Photos icon. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.]
...
![A nighttime photo of an alpine lake with a system-provided Live Photo badge with the text Live in the upper left corner.]

![A nighttime photo of an alpine lake with a system-provided Live Photo badge without text in the upper left corner.]
