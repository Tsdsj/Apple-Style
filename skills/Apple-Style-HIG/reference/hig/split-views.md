...
![An illustration of a laptop screen that shows two panes stacked vertically.]

**Horizontal**

![An illustration of a laptop screen that shows two panes arranged side by side, with a narrower pane on the left and a wider pane on the right.]

**Multiple**

![An illustration of a laptop screen divided into three panes, split both vertically and horizontally.]
...
![A screenshot showing a detail view with a vertical tab on Apple Watch. The page indicator next to the Digital Crown shows that the fifth tab is currently selected.]
