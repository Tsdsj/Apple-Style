...
![A screenshot on iPhone showing an airport map with the brand color used in all controls.]

![An X in a circle to indicate incorrect usage.]

![A screenshot on iPhone showing an airport map with the brand color in the content layer.]
