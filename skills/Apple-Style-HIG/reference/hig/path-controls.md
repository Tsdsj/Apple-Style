...
![A screenshot of a Finder path bar that displays a hierarchy of four locations.]
...
![A screenshot of a path control showing a folder icon and a pop-up control.]
