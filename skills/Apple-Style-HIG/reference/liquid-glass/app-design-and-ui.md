...
- [SwiftUI apps](https://developer.apple.com/documentation/technologyoverviews/swiftui) — Build your app for all Apple platforms using the Swift programming language and a modern approach.
- [UIKit and AppKit apps](https://developer.apple.com/documentation/technologyoverviews/uikit-appkit) — Build your app using a traditional design approach and the Swift or Objective-C programming language.

## Interface

- [Interface fundamentals](https://developer.apple.com/documentation/technologyoverviews/interface-fundamentals) — Explore the components that go into building your app’s interface, and discover platform-specific features that improve the experience you offer to people.
